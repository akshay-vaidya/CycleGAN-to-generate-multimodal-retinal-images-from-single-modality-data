...
class BaseOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--dataset_name', dest='dataset_name', default='multi', help='dataset name')
        parser.add_argument('--epochs', dest='epochs', type=int, default=25, help='# of epoch')
